    ...
    render() {
        ...
        return (
            <div className="gutter-example button-demo " style={{ height: '100%' }}>
                <BreadcrumbCustom first="工程维护养护管理" indexName="工程运行管理"/>
                    ...
                    <Col className="gutter-row" md={24}
                        ...
                        <div style={{ height: '100%' }}>
                            ...
                            <div style={{ height: '320px',overflowX:'hidden' }}>
                                <ExtBaseicTable {...(tableComs.project_maintenance_manger(expand))} />
                            </div>
                        </div>
                    </Col>
...
export default connect(mapStateToPorps, mapDispatchToProps)(Maintenance);