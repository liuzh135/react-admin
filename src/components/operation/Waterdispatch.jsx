    ...
    render() {
        ...
        return (
            <div className="gutter-example button-demo " style={{ height: '100%' }}>
                <BreadcrumbCustom first="水质监测管理" indexName="工程运行管理"/>
                    ...
                    <Col className="gutter-row" md={24}
                        ...
                        <div style={{ height: '100%' }}>
                            ...
                            <div style={{ height: '320px',overflowX:'hidden' }}>
                                <ExtBaseicTable {...(tableComs.project_water_monitoring_manger(expand))} />
                            </div>
                        </div>
                    </Col>
...
export default connect(mapStateToPorps, mapDispatchToProps)(Waterdispatch);