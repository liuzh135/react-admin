                                    ...
                                    <div className="y-center justify-content">
                                        ...
                                        <div style={{ flex: "5"}}>
                                            <Steps current={1} style={{width:'60%'}}>
                                                <Step status="process" title="水量调度方案制定"/>
                                                <Step status="process" title="水量调度执行"/>
                                                <Step status="process" title="水量调度应急管理"/>
                                            </Steps>
                                        </div>
...
export default connect(mapStateToPorps, mapDispatchToProps)(Waterquality);