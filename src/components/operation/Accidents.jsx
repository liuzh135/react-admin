    ...
    render() {
        ...
        return (
            <div className="gutter-example button-demo " style={{ height: '100%' }}>
                <BreadcrumbCustom first="安全事故调查处理" indexName="工程运行管理"/>
                    ...
                    <Col className="gutter-row" md={24}
                        ...
                        <div style={{ height: '100%' }}>
                                    ...
                                    <div className="y-center justify-content">
                                        ...
                                        <div style={{ flex: "5"}}>
                                            <Steps current={1} style={{width:'40%'}}>
                                                <Step status="process" title="上报安全事故"/>
                                                <Step status="process" title="事故调查报告"/>
                                                <Step status="process" title="事故处理"/>
                                            </Steps>
                                        </div>
                            ...
                            <div style={{ height: '320px',overflowX:'hidden' }}>
                                <ExtBaseicTable {...(tableComs.safety_accident_investigation_manger(expand))} />
                            </div>
                        </div>
                    </Col>
...
export default connect(mapStateToPorps, mapDispatchToProps)(Accidents);