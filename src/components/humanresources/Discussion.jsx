    ...
    render() {
        ...
        return (
            <div className="gutter-example button-demo " style={{ height: '100%' }}>
                <BreadcrumbCustom first="干部选拔任用管理" second="讨论决定" indexName="人力资源管理"/>
                    ...
                    <Col className="gutter-row" md={24}
                        ...
                        <div style={{ height: '100%' }}>
                            ...
                            <div style={{ height: '320px',overflowX:'hidden' }}>
                                <ExtBaseicTable {...(tableComs.hrm_discussion_and_decision_manger(expand))} />
                            </div>
                        </div>
                    </Col>
...
export default connect(mapStateToPorps, mapDispatchToProps)(Discussion);