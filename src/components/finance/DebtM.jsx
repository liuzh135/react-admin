...
class DebtM extends React.Component {
    ...
    render() {
        ...
        return (
            <div className="gutter-example button-demo ">
                <BreadcrumbCustom first="债权债务管理" second="债务管理" indexName="财务管理"/>
                    ...
                    <Col className="gutter-row" md={24}>
                        <div className="gutter-box">
                            <Card bordered={false}>
                                ...
                                <ExtBaseicTable {...tableComs.finance_debt_management_manger}/>
                            </Card>
                        </div>
                    </Col>
...
export default connect(mapStateToPorps, mapDispatchToProps)(DebtM);