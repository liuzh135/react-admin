...
class Brevenue extends React.Component {
    ...
    render() {
        ...
        return (
            <div className="gutter-example button-demo " style={{ height: '100%' }}>
                <BreadcrumbCustom first="预算管理" second="预算收入" indexName="财务管理"/>
...
export default connect(mapStateToPorps, mapDispatchToProps)(Brevenue);