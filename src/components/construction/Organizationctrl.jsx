...
class Organizationctrl extends React.Component {
    ...
    render() {
        ...
        return (
            <div className="gutter-example button-demo " style={{ height: '100%' }}>
                <BreadcrumbCustom first="组织协调" indexName="工程建设管理"/>
...
export default connect(mapStateToPorps, mapDispatchToProps)(Organizationctrl);