    ...
    render() {
        ...
        return (
            <div className="gutter-example button-demo ">
                <BreadcrumbCustom first="出国（境）管理" second="因私出国（境）" indexName="综合事务管理"/>
                        ...
                        <div className="gutter-box">
                            <Card bordered={false}>
                                <Steps current={1} style={{marginBottom:"15"}}>
                                    ...
                                    <Step status="wait" title="出国（境）活动" />
                                    <Step status="wait" title="回国（入境）后交还证件" />
                                </Steps>
                                ...
                                <ExtBaseicTable {...tableComs.private_manger}/>
                            </Card>
                        </div>
                    </Col>
