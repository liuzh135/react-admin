...
class TableComs {
    ...
    seal_manger_made_data = [{
        ...
        f_level: <span>{this.getStar(2, "star")}印章刻制，未经过严格的审核及审批，各部门擅自刻制印章，<br/>造成的不良后果及法律纠纷。</span>,
    ...
    seal_manger_use_data = [{
        ...
        steupName: '用印审批',
        objectM: <span>公司领导，刻印申请部门、综合<br/>管理部负责人及经办人</span>,
        f_level: <span>{this.getStar(2, "star")}印章使用未经严格审批，印章使用不登记、擅自使用印章。</span>,
    ...
    seal_manger_des_data = [{
        ...
        f_level: <span>{this.getStar(2, "star")}印章销毁审批不规范，导致应销毁印章未销毁，仍在使用。</span>,
        measures: <span>1.严格执行国家公章管理制度和公司印章管理规定；
    ...
    car_equipment_manger_data = [{
        ...
        f_level: <span>{this.getStar(2, "star")}超标准配车</span>,
    ...
    car_dispatch_manger_data = [{
        ...
        f_level: <span>{this.getStar(2, "star")}未经批准用车
        <br/>{this.getStar(2, "star")}公车私用</span>,
    ...
    car_repair_manger_data = [{
        ...
        f_level: <span>{this.getStar(2, "star")}不按规定进行车辆维修、保养，随意增加维修、保养项目
        <br/>{this.getStar(2, "star")}在费用报销过程中弄虚作假、虚报冒领</span>,
    ...
    car_charge_manger_data = [{
        ...
        steupName: '车辆加油',
        objectM: <span>车辆驾驶员</span>,
        f_level: <span>{this.getStar(2, "star")}使用公务用车加油卡给其他车辆加油。
        <br/>{this.getStar(2, "star")}在费用报销过程中弄虚作假、虚报冒领</span>,
    ...
    reception_manger_data = [{
        ...
        f_level: <span>{this.getStar(2, "star")}未经审批安排公务接待活动
        <br/>{this.getStar(2, "star")}公款吃喝</span>,
        ...
        f_level: <span>{this.getStar(2, "star")}超范围、超标准公务接待</span>,
        measures: <span>1.严格执行公司《公务接待管理暂行办法》，公务接待前填写接待审批单，注明接待对象、人数，陪同人数及领导，经公司领导审批后方可接待；
            <br/>2.严格公务接待费用报销程序，未经审批的公务接待活动费用，超范围、超标准公务接待费用，财务部一律不予报销；
            <br/>3.不定期开展专项检查，发现问题依规严肃处理。
        </span>,
        ...
        f_level: <span>{this.getStar(2, "star")}在费用报销过程中弄虚作假、虚报冒领
        <br/>{this.getStar(2, "star")}超范围、超标准公务接待</span>,
        measures: <span>1.严格执行公司《公务接待管理暂行办法》，公务接待前填写接待审批单，注明接待对象、人数，陪同人数及领导，经公司领导审批后方可接待；
            <br/>2.严格公务接待费用报销程序，未经审批的公务接待活动费用，超范围、超标准公务接待费用，财务部一律不予报销；
            <br/>3.不定期开展专项检查，发现问题依规严肃处理。
        </span>,
    ...
    private_manger_data = [{
        ...
        f_level: <span>{this.getStar(2, "star")}未经审批自行出国（境）
        <br/>{this.getStar(2, "star")}审核把关不严，造成不适宜人员出国（境）</span>,
        ...
        f_level: <span>{this.getStar(2, "star")}不及时交还证件
        </span>,
    ...
    public_manger_data = [{
        ...
        f_level: <span>{this.getStar(2, "star")}安排与工作结合不紧密、作为福利待遇性质的出国（境）活动
        </span>,
        ...
        f_level: <span>{this.getStar(2, "star")}团组成员未经团组组长同意单独活动；擅自变更出访路线或延长在国（境）外的期限
            <br/>{this.getStar(2, "star")}未及时公示出国团组费用
            <br/>{this.getStar(2, "star")}超标准乘坐交通工具
            <br/>{this.getStar(2, "star")}从事与出国任务无关的活动
        </span>,
    ...
    hrm_motion = [{
        ...
        f_level: <span>{this.getStar(2, "star")}工作方案中的职位、条件、范围、方式、程序不符合规定；
            <br/>{this.getStar(3, "star")}授意工作人员制定不符合规定的工作方案；
            <br/>{this.getStar(2, "star")}违反机构编制和领导职数规定，超职数配备干部。
        </span>,
    ...
    hrm_democracy_recommendation = [{
        ...
        steupName: '会议推荐',
        objectM: <span>公司领导班子成员，人力资源部负责人<br/>及相关人员</span>,
        f_level: <span>{this.getStar(2, "star")}通过请客、送礼等手段，向有关人员说情、拉票；
        <br/>{this.getStar(2, "star")}有关人员跑风漏气，干扰会议推荐工作。</span>,
        ...
        f_level: <span>{this.getStar(1, "star")}不按照规定进行谈话或不如实记录推荐情况；
        <br/>{this.getStar(1, "star")}谈话对象故意提供虚假信息；
        <br/>{this.getStar(1, "star")}谈话人事后泄露谈话内容。</span>,
        ...
        f_level: <span>{this.getStar(1, "star")}不如实汇总推荐情况。</span>,
        ...
        f_level: <span>{this.getStar(2, "star")}不把民主推荐结果作为确定考察对象依据或简单以票取人。</span>,
    ...
    hrm_inspect = [{
        ...
        steupName: '制定考察方案',
        objectM: <span>人力资源部负责人及相关人员</span>,
        f_level: <span>{this.getStar(1, "star")}不按规定组建考察组；
        <br/>{this.getStar(1, "star")}制定的考察方案不符合规定。</span>,
        ...
        f_level: <span>{this.getStar(1, "star")}不按规定发布干部考察预告。</span>,
        ...
        steupName: '实施考察',
        objectM: <span>考察组成员</span>,
        f_level: <span>{this.getStar(2, "star")}不按规定程序和范围进行考察，隐瞒、歪曲、泄露考察情况；
        <br/>{this.getStar(2, "star")}对线索清楚、内容具体的举报不进行核实或不如实报告；
        <br/>{this.getStar(2, "star")}不认真审核干部档案，导致干部信息不准确；
        <br/>{this.getStar(2, "star")}存在接受礼品礼金、参加消费活动等可能影响公正考察的行为。
        </span>,
        ...
        f_level: <span>{this.getStar(2, "star")}不按规定征求纪检监察部门对拟任人选的意见；
        <br/>{this.getStar(2, "star")}纪检监察部门不如实回复廉政鉴定意见；
        <br/>{this.getStar(2, "star")}对反映拟任人选问题性质严重、线索清楚、内容具体的举报不进行调查核实。
        </span>,
        ...
        f_level: <span>{this.getStar(1, "star")}不认真分析报告考察情况；
        <br/>{this.getStar(2, "star")}未按规定集体研究任用建议方案。
        <br/>{this.getStar(2, "star")}未按规定向公司主要负责人报告任用建议。
        </span>,
    ...
    hrm_discussion_and_decision = [{
        ...
        f_level: <span>{this.getStar(1, "star")}不按要求逐个介绍考察对象情况，故意隐瞒考察情况；
        <br/>{this.getStar(2, "star")}不如实向公司领导班子汇报拟报人选的提名、推荐、考察和任免理由等情况；
        <br/>{this.getStar(2, "star")}不如实向公司领导班子提供纪检监察部门的廉政鉴定意见。</span>,
        ...
        f_level: <span>{this.getStar(1, "star")}不按规定进行充分讨论；
        <br/>{this.getStar(1, "star")}临时动议干部任用事项。</span>,
        ...
        steupName: '集体表决形成决定',
        objectM: <span>公司领导班子成员</span>,
        f_level: <span>{this.getStar(2, "star")}参会人员未到达规定人数，仍然召开会议；
            <br/>{this.getStar(2, "star")}“三重一大”事项未提交公司总经理办公会/党委会研究决定；
            <br/>{this.getStar(2, "star")}主要领导（或会议召集人）先行发表倾向性意见，导致其他与会人员跟随主要领导，不能或不愿发表真实意见，集体决策流于形式；
            <br/>{this.getStar(2, "star")}未执行回避制度，影响决策成效。
        </span>,
        ...
        f_level: <span>{this.getStar(2, "star")}未按规定履行报备手续</span>,
    ...
    hrm_in_office = [{
        ...
        f_level: <span>{this.getStar(1, "star")}不按规定时间、范围和方式进行公示。</span>,
        ...
        f_level: <span>{this.getStar(2, "star")}对相关举报未按规定及时进行调查处理。</span>,
        ...
        steupName: '试用期满考核',
        objectM: <span>人力资源部负责人</span>,
        f_level: <span>{this.getStar(1, "star")}不按规定实行试用期制度；
            <br/>{this.getStar(1, "star")}不按规定程序和要求进行试用期满考核。
        </span>,
    ...
    hrm_recruitment = [{
        ...
        steupName: '编制招聘计划和方案',
        objectM: <span>人力资源部负责人</span>,
        f_level: <span>{this.getStar(1, "star")}超编制拟定招聘计划；
        <br/>{this.getStar(1, "star")}设置不合理的岗位资格条件，因人画像。</span>,
        ...
        f_level: <span>{this.getStar(1, "star")}资格审查过程中，随意变更报名资格条件，使得不符合报名资格的人员通过。</span>,
        ...
        f_level: <span>{this.getStar(2, "star")}泄露试题信息；
        <br/>{this.getStar(2, "star")}不真实记录笔试/面试成绩；
        <br/>{this.getStar(2, "star")}面试官受人请托，不公正打分；
        <br/>{this.getStar(2, "star")}设定不合理的录用分数线。
        </span>,
        ...
        steupName: '考察',
        objectM: <span>考察组成员</span>,
        f_level: <span>{this.getStar(2, "star")}考察程序不规范、不如实反映考察情况；
        <br/>{this.getStar(2, "star")}考察人接受请托，徇私舞弊。
        </span>,
        ...
        steupName: '确定拟聘人选',
        objectM: <span>人力资源部负责人</span>,
        f_level: <span>{this.getStar(2, "star")}不按规定确定拟录用人员。
        </span>,
        ...
        steupName: '公示',
        objectM: <span>人力资源部负责人</span>,
        f_level: <span>{this.getStar(2, "star")}不按规定公示拟聘人选。
        </span>,
    ...
    hrm_salary_and_welfare = [{
        ...
        f_level: <span>{this.getStar(1, "star")}薪酬福利调整事由不符合政策规定。</span>,
        ...
        objectM: <span>人力资源部薪酬福利管理岗</span>,
        f_level: <span>{this.getStar(2, "star")}相关人员人为干涉薪酬福利核算结果；
        <br/>{this.getStar(1, "star")}薪酬福利管理岗未严格按照政策规定核定薪酬福利。
        </span>,
        measures: <span>1.实行薪酬福利核定三级审批制度，包括经办人、审核人、审定人；
            <br/>2.加强信息系统建设，逐步实现薪酬福利管理信息化，减少人为因素干扰；
            <br/>3.薪酬福利调整信息应通过适当方式通知本人；
    ...
    hrm_other = [{
        ...
        f_level: <span>{this.getStar(1, "star")}未制定绩效考核方案，绩效考核工作不公开、公正；
        <br/>{this.getStar(2, "star")}考核对象通过非正常手段干扰绩效考评人员工作，影响绩效考核的公平公正；
        <br/>{this.getStar(1, "star")}不结合实际情况或者不经集体研究擅自决定相关人员考核等次。</span>,
        ...
        f_level: <span>{this.getStar(2, "star")}利用职务便利，为他人涂改、造假档案材料，圈划、抽取、撤换档案材料提供帮助。
        </span>,
        ...
        f_level: <span>{this.getStar(1, "star")}接受他人请托，让不符合申报条件人员通过职称申报资格审核。
        </span>,
        ...
        steupName: '培训管理',
        objectM: <span>公司领导班子成员、人力资源部负责人</span>,
        f_level: <span>{this.getStar(1, "star")}违规批准领导干部参加高收费社会化培训项目。</span>,
    ...
    finance_budget_expenditure_management = [{
        ...
        f_level: <span>{this.getStar(3, "star")}违规使用公款支付应由个人承担的费用；
        <br/>{this.getStar(3, "star")}违规使用购置办公用品等名义开支经费、虚开发票、用假发票；
        <br/>{this.getStar(3, "star")}会议费、培训费等支出内容不真实，以会议费等名义支出挂账，套取、转移资金；
        <br/>{this.getStar(3, "star")}虚报开支差旅、劳务、咨询、公务接待、车辆维护运行等费用。
        </span>,
    ...
    finance_cash_management = [{
        ...
        f_level: <span>{this.getStar(3, "star")}截留现金收入，取得现金收入不入账。
        <br/>{this.getStar(3, "star")}白条抵库、坐支现金；
        <br/>{this.getStar(3, "star")}公款私存。
        <br/>{this.getStar(3, "star")}大额提取现金，大额现金支付。
        </span>,
    ...
    finance_bank_account_management = [{
        ...
        f_level: <span>{this.getStar(3, "star")}未报审批擅自开立账户，规避监管，为谋取私利制造机会；
        <br/>{this.getStar(3, "star")}基于个人或小团体利益，在亲属或者特定关系人所在银行开立账户并存款；
        <br/>{this.getStar(2, "star")}擅自出借银行账户；
        <br/>{this.getStar(3, "star")}贪污、挪用账户资金。
        </span>,
    ...
    finance_bill_management = [{
        ...
        f_level: <span>{this.getStar(3, "star")}伪造、变造票据、套取资金，出借转让票据；
        </span>,
        ...
        steupName: '票据保管和核销',
        objectM: <span>财务部、票据使用部门负责人及经办人</span>,
        f_level: <span>{this.getStar(3, "star")}擅自销毁票据，隐匿收入，逃避监管。
        </span>,
        measures: <span>1.建立健全公司票据管理制度，严格执行票据使用规定，各部门明确专人负责票据申领，票据使用应做好记录；
            <br/>2.严格执行票据销毁有关规定，票据销毁必须交回财务部，统一销毁，各部门不得自行销毁，<br/>票据销毁应有2人以上同时在场，并做好记录。
            编制银行存款余额调节表；空白支付凭证与预留银行印鉴分人保管；
    ...
    finance_debt_right_management = [{
        ...
        f_level: <span>{this.getStar(2, "star")}受他人请托，对长期债权不催收，存在坏账损失。
        </span>,
        ...
        steupName: '对外借款',
        objectM: <span>公司领导、财务部负责人</span>,
        f_level: <span>{this.getStar(3, "star")}违反规定，擅自向外借款。
        </span>,
    ...
    finance_debt_management = [{
        ...
        steupName: '银行贷款',
        objectM: <span>公司领导、财务部负责人</span>,
        f_level: <span>{this.getStar(2, "star")}为谋取个人或小团体利益，未经集体研究，擅自决定向金融机构贷款。
        </span>,
        ...
        steupName: '对外担保',
        objectM: <span>公司领导、财务部负责人</span>,
        f_level: <span>{this.getStar(3, "star")}收受他人利益，违反规定，擅自对外提供担保。
        </span>,
    ...
    funds_project_collection = [{
        ...
        f_level: <span>{this.getStar(3, "star")}有倾向性地酝酿或选择项目，将与个人或部门有利益关联的项目列入征集建议；
            <br/>{this.getStar(2, "star")}提出对公司不利的投资建议方案，如投资总额明显偏高；
            <br/>{this.getStar(2, "star")}未在部门内征求意见。
        </span>,
        ...
        f_level: <span>{this.getStar(2, "star")}有倾向性的选择项目进行汇总，导致各部门征集的项目未列入公司《年度投资总体费用安排及项目计划》中；
            <br/>{this.getStar(2, "star")}将有利益关联的项目靠前排序，提高项目立项概率。
        </span>,
        ...
        f_level: <span>{this.getStar(2, "star")}实施方案不合理，为牟取私利，擅自改变项目内容、提高项目标准、超预算等。
        </span>,
...
//========================工程建设管理===========================//
    project_quality_control = [{
        ...
        f_level: <span>{this.getStar(2, "star")}项目经理、生产经理、技术负责人、质检员、安全员等不符合合同约定；
            <br/>{this.getStar(1, "star")}进场的施工人员不满足工程需要；
            <br/>{this.getStar(1, "star")}人员的资格条件不符合国家规定。
        </span>,
        ...
        steupName: '施工设备管理',
        objectM: <span>工程运行部、现场建设管理机构<br/>有关人员、监理单位的监理人员</span>,
        f_level: <span>{this.getStar(3, "star")}明示或暗示施工单位选择特定的施工设备供应和维养单位；
            <br/>{this.getStar(3, "star")}与施工设备供应和维养单位有利益关联；
            <br/>{this.getStar(1, "star")}进场的施工、试验、检测、测量等设备不满足工作需要或不符合合同约定；
            <br/>{this.getStar(1, "star")}在工程需要时，擅自将施工设备调离工地。
        </span>,
        ...
        steupName: '原材料管理',
        objectM: <span>工程运行部、现场建设管理机构<br/>有关人员、监理单位的监理人员</span>,
        f_level: <span>{this.getStar(3, "star")}明示或暗示承包人选择特定的材料供应商（生厂商）；
            <br/>{this.getStar(3, "star")}与材料供应商、生产商有利益关联；
            <br/>{this.getStar(2, "star")}默许使用不符合规定的材料；
            <br/>{this.getStar(1, "star")}不履行规定的质量检查检测程序；
            <br/>{this.getStar(3, "star")}不履行规定的质量检查检测程序
            <br/>{this.getStar(2, "star")}未制定严格的材料出入库管理制度，或执行不到位；
            <br/>{this.getStar(2, "star")}对检查检测发现的质量问题不及时处理或处理意见明显不合理。
        </span>,
        ...
        steupName: '施工组织设计',
        objectM: <span>工程运行部、现场建设管理机构<br/>有关人员、监理单位的监理人员</span>,
        f_level: <span>{this.getStar(3, "star")}与合同约定相比，施工组织设计（或施工措施计划）发生简化、相关标准降低。
        </span>,
        ...
        f_level: <span>{this.getStar(2, "star")}检验资料不全或评定资料不满足要求；
               <br/>{this.getStar(2, "star")}检验与评定程序不规范；
               <br/>{this.getStar(2, "star")}与第三方检测机构有利益关联；
               <br/> {this.getStar(3, "star")}改动或编造检验检测数据；
               <br/> {this.getStar(2, "star")}以质量缺陷的名义规避质量不合格，质量事故或质量缺陷备案手续不全；
               <br/>{this.getStar(1, "star")}检测方案存在明显缺陷。
        </span>,
        ...
        steupName: '现场质量检验与评定',
        objectM: <span>工程运行部、现场建设管理机构有关人员，<br/>监理单位的监理人员，第三方检测机构人员</span>,
        f_level: <span>{this.getStar(3, "star")}对事故等级的认定明显不合理；
               <br/> {this.getStar(2, "star")}对事故的原因认定或处理明显不合理。
        </span>,
        measures: <span>1.评定采用的技术标准和合同约定不一致时，应当进行论证；
             <br/>2.建立第三方检测机构利益关联回避制度；
             <br/>3.必要时，合同双方可分别委托第三方检测机构进行质量检验和评定；
    ...
    project_progress_control = [{
        ...
        f_level: <span>{this.getStar(2, "star")}工期延误责任确定明显不合理；
            <br/>{this.getStar(3, "star")}工期与费用索赔无合同依据，或采用的依据明显不合理。
        </span>,
        ...
        steupName: '进度计划检查',
        objectM: <span>计划资产部、现场建设管理机构有关人员，<br/>监理单位的监理人员</span>,
        f_level: <span>{this.getStar(1, "star")}实际进度与计划进度明显不符，且未按合同及时指出；
            <br/>{this.getStar(2, "star")}进度计划检查发现的问题未按合同要求采取措施或未及时采取措施。
        </span>,
        measures: <span>1.合同中明确约定合同延期责任确定；
                    <br/>2.制定进度保障措施，并严格执行；
                    <br/>3.进度计划的调整应进行论证，留下可追溯记录，重大调整需报计划资产部和工程运行部备案；
    ...
    project_investment_control = [{
        ...
        f_level: <span>{this.getStar(2, "star")}工程量的计算规则与合同约定不一致。
        </span>,
        ...
        steupName: '工程造价审核',
        objectM: <span>计划资产部、工程运行部、现场建设管理机构，<br/>监理单位、设计单位有关人员</span>,
        f_level: <span>{this.getStar(2, "star")}未按照合同约定审核工程造价。
        </span>,
        ...
        f_level: <span>{this.getStar(1, "star")}实际款项支付程序与合同约定不一致；
            <br/>{this.getStar(1, "star")}实际款项支付程序与合同约定不一致；
        </span>,
        ...
        f_level: <span>{this.getStar(1, "star")}指定开户银行或其他金融机构；
            <br/>{this.getStar(1, "star")}资金存储、借贷与工程建设需要明显矛盾；
            <br/>{this.getStar(2, "star")}建设成本开支明显不合理；
            <br/>{this.getStar(2, "star")}资金流向明显不合理。
        </span>,
    ...
    project_safety_control = [{
        ...
        f_level: <span>{this.getStar(1, "star")}未制定安全专项方案；
            <br/>{this.getStar(2, "star")}对安全措施不落实或落实不到位的情况未及时提出整改意见；
            <br/>{this.getStar(2, "star")}安全措施经费使用明显不到位。
        </span>,
        ...
        steupName: '控制措施',
        objectM: <span>工程运行部、现场建设管理机构有关人员，<br/>监理单位的监理人员</span>,
        f_level: <span>{this.getStar(1, "star")}实际实施的控制措施与批准的控制措施存在较明显的差距，未及时指出并留下记录；
            <br/>{this.getStar(3, "star")}明示或暗示安全措施中采用特定的单位（或个人）提供的材料、设备、技术等。
        </span>,
        measures: <span><br/> 1.建立安全责任制度，落实安全责任，实施安全检查记录制度；
             <br/>2.制定安全专项方案，并严格执行；
             <br/>3.材料、设备、技术使用需说明原因并备案；
        ...
        steupName: '安全事故处理',
        objectM: <span>工程运行部、现场建设管理机构有关人员，<br/>监理单位的监理人员</span>,
        f_level: <span>{this.getStar(2, "star")}对发现的事故报告不及时或隐瞒不报；
            <br/>{this.getStar(3, "star")}对事故等级的认定明显不合理；
            <br/>{this.getStar(2, "star")}对事故的原因认定、处理明显不合理。
        </span>,
        measures: <span><br/> 1.建立安全责任制度，落实安全责任，实施安全检查记录制度；
             <br/>2.制定安全专项方案，并严格执行；
             <br/>3.材料、设备、技术使用需说明原因并备案；
    ...
    project_business_management = [{
        ...
        f_level: <span>{this.getStar(2, "star")}变更索赔用理由不充分，或依据明显不合理；
            <br/>{this.getStar(2, "star")}变更索赔缺乏可追溯的支撑材料。
        </span>,
        ...
        f_level: <span>{this.getStar(2, "star")}明显的违规转包行为未给予追究；
            <br/>{this.getStar(2, "star")}分包行为不符合合同约定；
            <br/>{this.getStar(2, "star")}与分包单位有利益关联。
        </span>,
        ...
        f_level: <span>
            <br/>{this.getStar(2, "star")}补充条款（协议）内容理由不充分或支撑材料缺乏可追溯性；
            <br/>{this.getStar(2, "star")}补充条款（协议）明显倾向于特定单位。
        </span>,
    ...
    project_water_dispatch_management = [{
        ...
        f_level: <span>{this.getStar(3, "star")}未及时制定水量调度实施方案和月水量调度方案，<br/>
        ...
        steupName: '水量调度执行',
        objectM: <span>工程运行部负责人及相关人员</span>,
        f_level: <span>{this.getStar(3, "star")}未按照年度水量调度实施方案和月水量调度方案执行水量调度，调度令下达不及时，造成多调水或调水不足。
        </span>,
        ...
        steupName: '水量调度应急管理',
        objectM: <span>工程运行部负责人及相关人员</span>,
        f_level: <span>{this.getStar(2, "star")}应急响应不及时，导致不能有效预防和妥善处理突发事件，控制和消除突发事件的危害和影响。
        </span>,
    ...
    project_water_monitoring = [{
        ...
        f_level: <span>{this.getStar(2, "star")}委托监测单位未取得相应资质，水质监测管理不到位，不能保障输水水质监测数据准确。
            <br/>{this.getStar(3, "star")}水质监测工作人员改动原始监测数据，未及时报告真实水质情况且未做好保密工作。
        </span>,
    ...
    project_maintenance = [{
        ...
        f_level: <span>{this.getStar(2, "star")}工程维护保养与实际需求不符，出现过度保养或者缺乏保养等问题。
        </span>,
        ...
        objectM: <span>工程运行部、各级运行管理机构相关人员</span>,
        f_level: <span>{this.getStar(2, "star")}工程维护保养方案设计不合理，设计方案明显倾向特定人。
        </span>,
    ...
    project_safety_production_monitor = [{
        ...
        f_level: <span>{this.getStar(3, "star")}未组织开展安全监督检查；
                        <br/>{this.getStar(2, "star")}监督检查流于形式不能及时发现安全隐患，或发现问题后不报告。
        </span>,
        ...
        steupName: '安全隐患处理',
        objectM: <span>工程运行部、各级运行管理机构相关人员</span>,
        f_level: <span>{this.getStar(3, "star")}安全隐患发现后未能及时处理和解决，引发安全事故。
        </span>,
    ...
    safety_accident_investigation = [{
        ...
        steupName: '上报安全事故',
        objectM: <span>工程运行部、各级运行管理机构负责人及相关人员</span>,
        f_level: <span>{this.getStar(2, "star")}迟报、漏报、谎报、瞒报安全事故或者报告内容的信息不完整、不准确。
        </span>,
        ...
        f_level: <span>{this.getStar(2, "star")}安全事故调查报告描述与事实不符或审批不及时，导致事故调查报告失真、事故处理不到位，责任追究无法落实。
        </span>,
        ...
        f_level: <span>{this.getStar(2, "star")}对安全事故处理责任人不及时进行处理，无充分理由减轻或加重对责任人处罚。
        </span>,
    ...
    tendering_and_bidding = [{
        ...
        f_level: <span>{this.getStar(2, "star")}应招标而不招标，或将项目化整为零规避招标；
            <br/>{this.getStar(1, "star")}邀请招标理由不充分，或邀请招标规避程序，或邀请投标的单位范围明显过窄；
            <br/>{this.getStar(2, "star")}应当重新招标时，不重新招标；
            <br/>{this.getStar(2, "star")}选择有利益关联的招标代理机构；
            <br/>{this.getStar(2, "star")}选择有利益关联的电子招标投标交易平台。
        </span>,
        ...
        f_level: <span>{this.getStar(2, "star")}资质条件或废标条款明显不合理，排斥潜在投标人或倾向特定人；
            <br/>{this.getStar(2, "star")}评标标准明显不合理或倾向特定人或明显妨碍公平；
            <br/>{this.getStar(1, "star")}招标文件未履行必要的审查或审批程序。
        </span>,
        ...
        steupName: '招标公告发布',
        objectM: <span>履约责任部门、招标管理中心有关人员，<br/>设计单位、招标代理机构工作人员</span>,
        f_level: <span>{this.getStar(1, "star")}应发而未发公告，或未在规定媒介发布公告；
            <br/>{this.getStar(1, "star")}邀请招标时，邀请范围明显倾向于利益关联者或明显不经济。
        </span>,
        ...
        f_level: <span>{this.getStar(2, "star")}透露购买招标文件的潜在投标人等可能影响公平竞争的信息。
        </span>,
        ...
        f_level: <span>{this.getStar(1, "star")}仅向部分投标人透露影响招投标结果的实质信息。
        </span>,
        ...
        objectM: <span>招标管理中心、履约责任部门、招标代理机构工作人员</span>,
        f_level: <span>{this.getStar(1, "star")}招标文件的澄清和修改通知明显倾向于特定潜在投标人。
        </span>,
        ...
        steupName: '开标',
        objectM: <span>招标管理中心、履约责任部门、招标代理机构工作人员</span>,
        f_level: <span>{this.getStar(1, "star")}投标人数量达不到法定数量仍继续开标，或不按规定时间或地点开标。
        </span>,
        ...
        f_level: <span>{this.getStar(2, "star")}无充分理由，指定部分评标专家；
            <br/>{this.getStar(2, "star")}泄露评标委员会组成人员信息。
        </span>,
        ...
        f_level: <span>{this.getStar(2, "star")}明示或暗示招标代理机构、评标委员会选择潜在投标人；
            <br/>{this.getStar(1, "star")}泄露有关评标过程，或打探不应了解的信息，或在评审人员之间泄露不应当泄露的信息。
        </span>,
        ...
        steupName: '中标公示',
        objectM: <span>招标管理中心有关人员，招标代理机构工作人员</span>,
        f_level: <span>{this.getStar(1, "star")}未按评标委员会的评标报告公示中标候选人。
        </span>,
        ...
        f_level: <span>{this.getStar(2, "star")}未按评标委员会推荐的中标候选人顺序确定中标人。
        </span>,
        ...
        f_level: <span>{this.getStar(2, "star")}与中标人订立背离合同实质性内容的其他协议。
        </span>,
    ...
    project_setting = [{
        ...
        f_level: <span>{this.getStar(2, "star")}不按照合同立项管理规定进行立项审批。
        </span>,
    ...
    contract_formation = [{
        ...
        steupName: '合同文本起草',
        objectM: <span>履约责任部门负责人及经办人</span>,
        f_level: <span>{this.getStar(2, "star")}合同拟定中故意隐含重大疏漏和欺诈，导致公司合法利益受损。
        </span>,
        ...
        f_level: <span>{this.getStar(2, "star")}授意签订虚假合同，谋取私利或套取、转移资金。
        </span>,
    ...
    contract_fulfilment = [{
        ...
        steupName: '合同执行',
        objectM: <span>履约责任部门负责人及经办人</span>,
        f_level: <span>{this.getStar(2, "star")}发现合同履行过程的重大问题未采取措施，纠纷处理不当致使公司利益受损；
            <br/>{this.getStar(2, "star")}编造工作量、虚假工作进度、隐匿质量问题，进行虚假结算。
        </span>,
        ...
        f_level: <span>{this.getStar(1, "star")}不按合同规定期限、金额或方式付款，导致公司利益受损。
        </span>,
        ...
        f_level: <span>{this.getStar(2, "star")}合同指标未完成的情况通过验收，导致公司利益受损。
        </span>,
    ...
    asset_allocation = [{
        ...
        f_level: <span>{this.getStar(2, "star")}虚假购置，少采多报、低采高报，超标准采购。
        </span>,
    ...
    asset_use1 = [{
        ...
        f_level: <span>{this.getStar(1, "star")}领用借用资产不按规定交还。
        </span>,
    ...
    asset_use2 = [{
        ...
        f_level: <span>{this.getStar(2, "star")}资产维修维护虚报多报、套取资金。
        </span>,
    ...
    asset_use3 = [{
        ...
        f_level: <span>{this.getStar(3, "star")}未履行相关审批程序，擅自对外出租出借资产。
        </span>,
    ...
    asset_use4 = [{
        ...
        steupName: '资产清查',
        objectM: <span>综合管理部、财务部、资产使用部门负责人及经办人</span>,
        f_level: <span>{this.getStar(2, "star")}在资产清查中虚报瞒报国有资产。
        </span>,
    ...
    asset_use5 = [{
        ...
        f_level: <span>{this.getStar(3, "star")}资产有偿使用收益没有及时纳入部门预算或上缴专户，截留、挪用、私分。
        </span>,
    ...
    asset_use6 = [{
        ...
        steupName: '出资人管理',
        objectM: <span>公司领导</span>,
        f_level: <span>{this.getStar(2, "star")}国有资产出资人管理职责缺位或越位。
        </span>,
    ...
    assets_disposal1 = [{
        ...
        steupName: '资产评估',
        objectM: <span>公司领导、综合管理部、财务部负责人</span>,
        f_level: <span>{this.getStar(3, "star")}故意提供虚假情况和资料，或者与资产评估机构串通作弊，导致资产评估结果失实。
        </span>,
    ...
    assets_disposal2 = [{
        ...
        steupName: '资产处置',
        objectM: <span>公司领导、综合管理部、财务部负责人</span>,
        f_level: <span>{this.getStar(3, "star")}未经审批，批擅自处置国有资产；
            <br/>{this.getStar(2, "star")}违规核销货币性资产；
            <br/>{this.getStar(3, "star")}国有资产处置不透明、暗箱操作。
        </span>,
    ...
    assets_disposal3 = [{
        ...
        f_level: <span>{this.getStar(3, "star")}资产处置收入未及时收缴，存在截留、挪用、私分情况。
        </span>,
    ...
    internal_audit_monitoring = (expand) => [{
        ...
        key: '1',
        steupName: '制定年度审计计划',
        objectM: <span>监察审计部负责人、审计岗</span>,
