...
class SealUse extends React.Component {
    ...
    render() {
        ...
        return (
            <div className="gutter-example button-demo ">
                <BreadcrumbCustom first="印章管理" second="印章使用" indexName="综合事务管理"/>

                <Row gutter={10}>
                    <Col className="gutter-row" md={24}>
                        <div className="gutter-box">
                            <Card bordered={false} >
                                <Steps current={2} style={{marginBottom:"15px"}}>
                                ...
                                <ExtBaseicTable {...tableComs.seal_use_manger}/>
                            </Card>
                        </div>
                    </Col>
...
export default connect(mapStateToPorps, mapDispatchToProps)(SealUse);