...
class SealDes extends React.Component {
    ...
    render() {
        ...
        return (
            <div className="gutter-example button-demo ">
                <BreadcrumbCustom first="印章管理" second="印章销毁" indexName="综合事务管理"/>
                    ...
                    <Col className="gutter-row" md={24}>
                        <div className="gutter-box">
                            <Card bordered={false} >
                                ...
                                <ExtBaseicTable {...tableComs.seal_des_manger}/>
                            </Card>
                        </div>
                    </Col>
...
export default connect(mapStateToPorps, mapDispatchToProps)(SealDes);