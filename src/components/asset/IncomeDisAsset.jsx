...
class IncomeDisAsset extends React.Component {
    ...
    render() {
        ...
        return (
            <div className="gutter-example button-demo " style={{ height: '100%' }}>
                <BreadcrumbCustom first="资产处置"  second="处置收入管理" indexName="资产管理"/>
                    ...
                    <Col className="gutter-row" md={24}
                        ...
                        <div style={{ height: '100%' }}>
                            ...
                            <div style={{ overflow: 'scroll', height: '95%' }}>
                                <ExtBaseicTable {...(tableComs.assets_disposal_manger3(expand))} />
                            </div>
                        </div>
                    </Col>
...
export default connect(mapStateToPorps, mapDispatchToProps)(IncomeDisAsset);