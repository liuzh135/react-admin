...
class CarDispatch extends React.Component {
    ...
    render() {
        ...
        return (
            <div className="gutter-example button-demo " style={{ height: '100%' }}>
                <BreadcrumbCustom first="公务用车管理" second="车辆调度" indexName="综合事务管理"/>
                    ...
                    <Col className="gutter-row" md={24}
                        ...
                        <div style={{ height: '100%' }}>
                                ...
                                <Layout style={{ background: "#fff" }}>
                                    <div className="y-center justify-content">
                                        ...
                                        <Steps current={1} style={{ flex: "6" }}>
                                            <Step status="process" title="用车申请"/>
                                            <Step status="process" title="审批"/>
                                            <Step status="process" title="安排用车"/>
                                        </Steps>
                            ...
                            <div style={{ height: '320px',overflowX:'hidden' }}>
                                <ExtBaseicTable {...(tableComs.car_dispatch_manger(expand))} />
                            </div>
                        </div>
                    </Col>
...
export default connect(mapStateToPorps, mapDispatchToProps)(CarDispatch);