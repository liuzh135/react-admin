    ...
    render() {
        ...
        return (
            <div className="gutter-example button-demo ">
                <BreadcrumbCustom first="公务用车管理" second="维修保养" indexName="综合事务管理"/>
                    ...
                    <Col className="gutter-row" md={24}>
                        <div className="gutter-box">
                            <Card bordered={false}>
                                ...
                                <ExtBaseicTable {...tableComs.car_repair_manger}/>
                            </Card>
                        </div>
                    </Col>
...
export default connect(mapStateToPorps, mapDispatchToProps)(CarRepair);